...
/**
 * Popup overlay for editing disk partition.
 * Shows 63 slots, click to remove, JEI drag to add.
 */
public class PopupDiskPartition extends Gui {
    ...
    public PopupDiskPartition(GuiScreen parent, DiskInfo disk, int mouseX, int mouseY) {
        this.parent = parent;
        this.disk = disk;
