 ...
 *   <li>NBT is split per channel and sent to clients via the chunked protocol
 *       ({@code PacketNBTChunk} + {@code ChunkedNBTSender} on the server,
 *       {@code ChunkedNBTReceiver} + {@code PayloadDispatcher} on the client).</li>
