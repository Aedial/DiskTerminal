...
/**
 * Wireless wireless version of the Cell Terminal.
...
public class ItemWirelessCellTerminal extends AEBasePoweredItem implements IWirelessTermHandler, IBauble {
    ...
    public ItemWirelessCellTerminal() {
        ...
        this.setRegistryName(Tags.MODID, "wireless_cell_terminal");
        this.setTranslationKey(Tags.MODID + ".wireless_cell_terminal");
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (!world.isRemote) {
            ...
            GuiHandler.openWirelessCellTerminalGui(player, slot, false);
        }
    ...
    public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
        // No magnet logic for cell terminal
    }
}
