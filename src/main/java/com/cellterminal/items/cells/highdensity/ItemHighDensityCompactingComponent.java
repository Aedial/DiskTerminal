...
/**
 * High-Density Compacting storage component item.
 * Used to craft high-density compacting storage cells.
 * 
 ...
 */
public class ItemHighDensityCompactingComponent extends Item {
    ...
    public ItemHighDensityCompactingComponent() {
        setMaxStackSize(64);
        setHasSubtypes(true);
        setMaxDamage(0);
        setCreativeTab(CreativeTab.instance);
        setRegistryName(Tags.MODID, "high_density_compacting_component");
        setTranslationKey(Tags.MODID + ".high_density_compacting_component");
    }
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        tooltip.add("\u00a7d" + I18n.format("tooltip.cellterminal.high_density_component.info"));
    }
    ...
    public static ItemStack create(int tier) {
        ...
        return new ItemStack(com.cellterminal.ItemRegistry.HIGH_DENSITY_COMPACTING_COMPONENT, 1, tier);
    }
