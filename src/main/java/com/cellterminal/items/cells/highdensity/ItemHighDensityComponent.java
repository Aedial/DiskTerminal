...
/**
 * High-Density storage component item.
 * Used to craft high-density storage cells.
 * 
 ...
 * - 10: 1G HD Component
 */
public class ItemHighDensityComponent extends Item {
    ...
    public ItemHighDensityComponent() {
        setMaxStackSize(64);
        setHasSubtypes(true);
        setMaxDamage(0);
        setCreativeTab(CreativeTab.instance);
        setRegistryName(Tags.MODID, "high_density_component");
        setTranslationKey(Tags.MODID + ".high_density_component");
    }
    ...
    public static ItemStack create(int tier) {
        ...
        return new ItemStack(com.cellterminal.ItemRegistry.HIGH_DENSITY_COMPONENT, 1, tier);
    }
