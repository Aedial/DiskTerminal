...
/**
 * GUI for Cell Terminal when opened via AE2WUT's Wireless Universal Terminal.
 * Same functionality as GuiWirelessCellTerminal but works with WUT's system.
 */
public class GuiWUTCellTerminal extends GuiCellTerminalBase {

    private final WirelessTerminalGuiObject wirelessTerminalGuiObject;
    private WUTModeSwitcher modeSwitcher;

    public GuiWUTCellTerminal(InventoryPlayer playerInventory, WirelessTerminalGuiObject wth) {
        super(new ContainerWUTCellTerminal(playerInventory, wth));
     ...
     */
    public ContainerWUTCellTerminal getWUTContainer() {
        return (ContainerWUTCellTerminal) this.inventorySlots;
    }
