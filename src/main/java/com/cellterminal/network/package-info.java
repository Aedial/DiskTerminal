 ...
 * <ul>
 *   <li>{@link com.cellterminal.network.chunked.PacketNBTChunk}: Generic chunked NBT
 *       payload carrying full GUI state (cells, buses, subnets) split across multiple chunks
 *       to stay under the engine's per-packet size cap. See
 *       {@link com.cellterminal.network.chunked.TerminalChannels} for the channel list.</li>
